...
const StaffLeadGeneration = ({ data }) => {
        ...
        <>
            <div
                ...
                <div className={`flex items-center gap-4 p-2  ml-5`}>
                    <BsFillPersonFill className={`${!data && "scale-125" && "text-white"} transform`} />
                    <span
            ...
            <div
                ...
                <ul className='flex flex-col ' >
                    ...
                    <Link to="Staff_Lead_followup_date_report" >
                        <li className='hover:text-white pt-2 ' >
                            <a href="#">
                                Leads Followup Data Report
                            </a>
                        </li>
                    </Link>
...
export default StaffLeadGeneration
