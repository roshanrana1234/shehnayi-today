...
import { UseGetSuspended } from '../../../../Hooks/UseData';
...
const SuspendedMember = () => {
    ...
    const { data, isLoading, error, isError } = UseGetSuspended()
            ...
            <div className='flex gap-4' >
                ...
                <div className='grid sm:grid-cols-2 py-6 place-items-center gap-6 my-10' >
                    ...
                    <div className='flex gap-4' >
                        ...
                        <span>Entries</span>
                        <button
                            className='text-white font-bold bg-green-500 p-3 rounded-lg'
                            onClick={() => handlepages()}
                        >
                            Change
                        </button>
...
export default SuspendedMember